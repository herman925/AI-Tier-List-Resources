...
export const settings = {
    ...
    csvPath: 'data/ai_tools.csv', // Path to the main AI data CSV
    tiersPath: 'data/tiers.csv', // Path to the tiers definition CSV
    featuresPath: 'data/features.json', // Path to the features definition JSON
